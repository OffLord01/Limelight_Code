...
public static final class Tracao {
 ...
 // 1)
 public static final double multiplicadorRotacional = -0.2;
 // constante para diminuir o input do joystick (y)
 public static final double multiplicadorTranslacionalY = 0.2;
 // constante para diminuir o input do joystick (x)
 public static final double multiplicadorTranslacionalX = 0.2;
 //Velocidade maxima 
 public static final double velocidadeMax = 0.5;
